...
class Car:
    ...
    crucial_points = tf.concat([np.zeros_like(front_left), front_left, front_right, back_right, back_left], axis=0)
    ...
    contour = tf.cast(tf.concat([front, left, back, right], axis=0), tf.float32)
